...
class Ui_RecipeListWindow(object):
    def setupUi(self, RecipeListWindow):
        ...
        self.actionWhat_s_This = QtWidgets.QAction(RecipeListWindow)
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/icons/information.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionWhat_s_This.setIcon(icon12)
        self.actionWhat_s_This.setShortcut("Shift+F1")
        ...
        self.actionShow = QtWidgets.QAction(RecipeListWindow)
        ...
        self.menuSettings.addAction(self.actionShow)
    ...
    def retranslateUi(self, RecipeListWindow):
        ...
        self.actionWhat_s_This.setText(_translate("RecipeListWindow", "What\'s This?"))
        self.actionFilter.setText(_translate("RecipeListWindow", "Filter"))
        self.actionShow.setText(_translate("RecipeListWindow", "Show"))
